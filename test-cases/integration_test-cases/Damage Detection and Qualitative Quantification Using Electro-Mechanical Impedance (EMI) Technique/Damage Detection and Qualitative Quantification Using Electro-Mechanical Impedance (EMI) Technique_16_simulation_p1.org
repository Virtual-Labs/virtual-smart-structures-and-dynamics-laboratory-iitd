...
* Objective
  - To Simulate for 'Incipient' of “Damage Detection and Qualitative Quantification Using Electro-Mechanical Impedance (EMI) Technique” experiment
...
* Test Steps
  ...
  4. Enter the values in only one fields and click on the Submit button

* Expected result
  1. Experiment home page should be opened
  2. Content should be present with no distortions and Junk characters
  3. It should redirect to the simulation page 
  4. An error message should be displayed on the screen as to enter all the values
