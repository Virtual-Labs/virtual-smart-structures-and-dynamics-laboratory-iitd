...
* Objective
  - To plot a graph between frequency and length of “Modes of Vibrations of Beams under flexure” experiment
...
* Test Steps
  ...
  3. Enter the valid values in the corresponding fields and click on the Plot graph button
