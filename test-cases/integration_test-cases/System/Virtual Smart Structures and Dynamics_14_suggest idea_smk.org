...
* Objective
  - To suggest an idea for  "Virtual Smart Structures and Dynamics" lab
...
* Test Steps
  ...
  3. Click on the 'Submit your idea' link ,which is displayed on the screen

* Expected result
  1. Lab home page should be opened
  2. Content should be present with no distortions and Junk characters
  3. A compose email box should be opened
