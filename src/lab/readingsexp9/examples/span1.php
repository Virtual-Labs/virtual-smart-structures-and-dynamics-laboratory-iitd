...
<h2 class="style4">Line Graph for Incipient </h2>
<table width="120%"> 
  <tr> 
     <td width="4%" height="440" valign="middle"><img src="image/cond.jpg" width="19" height="130" /></td> 
    ...
    <td width="20%" valign="middle" style="text-align:center;"><p> </p>
      ...
      <p>
        <input   name="Button" type="button" class="style6" title="CLICK ON" onClick="window.open('span1_data.xlsx', 'download'); return false;" value="Download Data!">
      </p></td> 
  </tr> 
</table> 
