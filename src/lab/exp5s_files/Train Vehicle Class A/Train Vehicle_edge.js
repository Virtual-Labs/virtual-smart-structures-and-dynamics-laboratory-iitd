                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['27px', '176px', '277px', '19px', 'auto', 'auto'],
                            text: "<p style=\"margin:0px\">Data is downloaded in the status bar and SHM of span 3 is going on​</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [17, "px"], "rgba(195,46,5,1.00)", "700", "underline solid rgb(0, 0, 0)", "normal", "break-word", "normal"]
                        },
                        {
                            id: 'RectangleCopy2',
                            type: 'rect',
                        ...
                        },
                        {
                            id: 'Text3Copy4',
                            type: 'text',
                            rect: ['12px', '270px', '53px', '18px', 'auto', 'auto'],
                            opacity: '1',
                            text: "<p style=\"margin: 0px; text-align: center;\">LED​s</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [14, "px"], "rgba(0,0,0,1)", "400", "none solid rgb(0, 0, 0)", "normal", "break-word", "normal"],
                            filter: [0, 0, 1, 1, 0, 0, 0, 0, "rgba(0,0,0,0)", 0, 0, 0]
                        },
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'rect',
                            rect: ['49px', '79px', '253px', '40px', 'auto', 'auto'],
                            cursor: 'pointer',
                            fill: ["rgba(245,57,186,1.00)"],
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'rect',
                            rect: ['98px', '154px', '175px', '24px', 'auto', 'auto'],
                            cursor: 'pointer',
                            borderRadius: ["10px", "10px", "10px", "10px"],
                            fill: ["rgba(72,188,75,1.00)"],
                            stroke: [0,"rgb(0, 0, 0)","none"]
                        },
                        {
                            id: 'Text13',
                            display: 'none',
                            type: 'text',
                            rect: ['109px', '158px', '165px', '20px', 'auto', 'auto'],
                            cursor: 'pointer',
                            text: "<p style=\"margin:0px\">Click here to continue​</p>",
                            font: ['Arial, Helvetica, sans-serif', [14, "px"], "rgba(0,0,0,1)", "700", "none", "", "break-word", "normal"]
                        },
                        {
                            id: 'Text4',
                            display: 'none',
                            type: 'text',
                            rect: ['59px', '87px', '248px', '7px', 'auto', 'auto'],
                            cursor: 'pointer',
                            text: "<p style=\"margin:0px\">​Click to download undamaged data for all four spans shown below</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [14, "px"], "rgba(0,0,0,1.00)", "700", "none solid rgb(0, 0, 0)", "normal", "break-word", "normal"]
                        },
                        {
                            id: 'Rectangle9',
                            display: 'none',
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['35px', '171px', '250px', '44px', 'auto', 'auto'],
                            text: "<p style=\"margin:0px\">Data is downloaded in the status bar </p><p style=\"margin:0px\">and SHM of span 1 is going on...​</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [14, "px"], "rgba(195,46,5,1.00)", "700", "none solid rgb(0, 0, 0)", "italic", "break-word", "normal"]
                        },
                        {
                            id: 'Rectangle10',
                            display: 'none',
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['26px', '173px', '350px', '32px', 'auto', 'auto'],
                            text: "<p style=\"margin:0px\">Data is downloaded in the status bar and SHM of span 2 is going on...​</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [17, "px"], "rgba(195,46,5,1.00)", "700", "none solid rgb(0, 0, 0)", "italic", "break-word", "normal"]
                        },
                        {
                            id: 'Rectangle11Copy',
                            display: 'none',
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['38px', '172px', '264px', '44px', 'auto', 'auto'],
                            text: "<p style=\"margin:0px\">Data is downloaded in the status bar and SHM of span 4 is going on...​</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [15, "px"], "rgba(195,46,5,1.00)", "700", "none solid rgb(0, 0, 0)", "italic", "break-word", "normal"]
                        },
                        {
                            id: 'Rectangle11',
                            display: 'none',
                        ...
                        },
                        {
                            ...
                            text: "Click all the tags to take the signature of bridge in corresponding spans for damaged condition.",
                            align: "justify",
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'image',
                            rect: ['499px', '43px', '87px', '81px', 'auto', 'auto'],
                            cursor: 'pointer',
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'rect',
                            rect: ['206px', '49px', '126px', '44px', 'auto', 'auto'],
                            cursor: 'pointer',
                            borderRadius: ["10px", "10px", "10px", "10px"],
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'rect',
                            rect: ['350px', '49px', '126px', '44px', 'auto', 'auto'],
                            cursor: 'pointer',
                            borderRadius: ["10px", "10px", "10px", "10px"],
                            fill: ["rgba(245,163,57,1)"],
                            stroke: [0,"rgb(0, 0, 0)","none"]
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['30px', '54px', '165px', '31px', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\">​Click the buttons of all four spans shown on the right side to induce damage and download damaged state data:<span style=\"font-size: 20px;\">​</span></p>",
                            align: "justify",
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['235px', '55px', '77px', '31px', 'auto', 'auto'],
                            cursor: 'pointer',
                            text: "<p style=\"margin: 0px;\">​Span 1</p>",
                            align: "left",
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['378px', '55px', '77px', '31px', 'auto', 'auto'],
                            cursor: 'pointer',
                            text: "<p style=\"margin: 0px;\">​Span 3</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [20, "px"], "rgba(0,0,0,1)", "700", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            ...
                            display: 'none',
                            type: 'rect',
                            rect: ['352px', '104px', '126px', '44px', 'auto', 'auto'],
                            cursor: 'pointer',
                            borderRadius: ["10px", "10px", "10px", "10px"],
                            fill: ["rgba(245,163,57,1)"],
                            stroke: [0,"rgb(0, 0, 0)","none"]
                        },
                        {
                            ...
                            display: 'none',
                            type: 'rect',
                            rect: ['206px', '104px', '126px', '44px', 'auto', 'auto'],
                            cursor: 'pointer',
                            borderRadius: ["10px", "10px", "10px", "10px"],
                            fill: ["rgba(245,163,57,1)"],
                            stroke: [0,"rgb(0, 0, 0)","none"]
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['235px', '112px', '77px', '31px', 'auto', 'auto'],
                            cursor: 'pointer',
                            text: "<p style=\"margin: 0px;\">​Span 2</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [20, "px"], "rgba(0,0,0,1)", "700", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['380px', '112px', '77px', '31px', 'auto', 'auto'],
                            cursor: 'pointer',
                            text: "<p style=\"margin: 0px;\">​Span 4</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [20, "px"], "rgba(0,0,0,1)", "700", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            ...
                            display: 'none',
                            type: 'image',
                            rect: ['335px', '431px', '46px', '61px', 'auto', 'auto'],
