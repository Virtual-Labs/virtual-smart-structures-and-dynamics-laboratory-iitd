...
<script src="Scripts/line.js" type="text/javascript">
</script>
</head>
...
<h2 class="style4">Line Graph for Pristine </h2>
<table width="120%"> 
  <tr> 
    ...
    <td width="20%" valign="middle" style="text-align:center;"><p> </p>
      ...
      <input   name="Button" type="button" class="style6" title="CLICK ON" onClick="window.open('pristine.zip', 'download'); return false;" value="Download Data!">
</p></td> 
  </tr> 
</table> 
