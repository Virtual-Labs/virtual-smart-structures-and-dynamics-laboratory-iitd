...
<div align="right" class="style25"><a href="../../exp7.html"  title="CLICK ON" class="style9">NEXT-EXPERIMENT</a></div>
<h2 class="style4">Line Graph for Severe </h2>
...
<table width="120%"> 
  <tr> 
    ...
    <td width="20%" valign="middle" style="text-align:center;"><p> </p>
      ...
      <p>
        <input   name="Button" type="button" class="style6" title="CLICK ON" onClick="window.open('severe.zip', 'download'); return false;" value="Download Data!">
      </p></td> 
  </tr> 
</table> 
...
<p align="center" class="style30"><span class="style31 style11"> signature acquisition in process</span>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
</body>
</html>