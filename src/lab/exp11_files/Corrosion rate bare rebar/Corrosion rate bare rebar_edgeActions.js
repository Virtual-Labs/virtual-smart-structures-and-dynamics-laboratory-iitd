...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${Text10Copy2}", "click", function(sym, e) {
         window.open("http://ssdl.iitd.ac.in/vssdl/exp11_files/comparison_exp11_exp1.xlsx", "_blank");
      ...
      Symbol.bindElementAction(compId, symbolName, "${RoundRect4}", "click", function(sym, e) {
         window.open("http://ssdl.iitd.ac.in/vssdl/exp11_files/comparison_exp11_exp1.xlsx", "_blank");
      ...
      Symbol.bindElementAction(compId, symbolName, "${Text10Copy4}", "click", function(sym, e) {
         window.open("http://ssdl.iitd.ac.in/vssdl/exp11_files/k_m_values_bare_rebar.docx", "_blank");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${RoundRect3Copy3}", "click", function(sym, e) {
         window.open("http://ssdl.iitd.ac.in/vssdl/exp11_files/k_m_values_bare_rebar.docx", "_blank");
      ...
      Symbol.bindElementAction(compId, symbolName, "${Text10Copy5}", "click", function(sym, e) {
         window.open("http://ssdl.iitd.ac.in/vssdl/exp11_files/corr_rate.docx", "_blank");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${RoundRect3Copy4}", "click", function(sym, e) {
         window.open("http://ssdl.iitd.ac.in/vssdl/exp11_files/corr_rate.docx", "_blank");
